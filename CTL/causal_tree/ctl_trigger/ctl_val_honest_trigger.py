    ...
    def _fit(self, node: TriggerValidationNode, train_x, train_y, train_t, val_x, val_y, val_t):
        ...
        for col in range(0, column_count):
            ...
            for value in unique_vals:
                ...
                tb_control_share = 1 - tb_treated_share if tb_nt > 0 else 1.0
                fb_treated_share = tb_nt / train_x.shape[0] if fb_nt > 0 else 1.0
                fb_control_share = 1 - fb_treated_share if fb_nt > 0 else 1.0
                ...
                fb_var = (1 + self.train_to_est_ratio) * (
                        (var_treat1 / fb_treated_share) + (var_control1 / fb_control_share))
